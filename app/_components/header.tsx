...
export default function Header() {
  ...
  return (
    ...
    >
      <CardHeader className="px-4 sm:px-6 flex flex-col gap-3 sm:flex-row sm:items-center sm:gap-6">
        ...
        <div className="flex items-center gap-3 sm:gap-4">
          <Image
            ...
            width={48}
            height={48}
            className="size-10 sm:size-12 mr-3 sm:mr-4"
          />
          <div className="flex flex-col sm:flex-row sm:items-center sm:gap-6">
            <HeaderTitle>UI/UX DESIGNER</HeaderTitle>
            <div className="flex items-center gap-2">
              <HeaderTitle>BASED IN PHILIPPINES</HeaderTitle>
              <Image
        ...
        {/* Right: links */}
        <nav className="order-last sm:order-none flex flex-wrap items-center gap-3 sm:gap-5 sm:ml-auto text-sm sm:text-base">
...
function HeaderLink({ href, className, children }: {
  ...
  const base = cn(
    "leading-none",
    // readable default, relying on CSS variables
    "text-foreground",
    // subtle inactive state, brighten on hover
