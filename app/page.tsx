      ...
      <PageSection id="home">
        <div className="grid gap-8 sm:gap-10 md:grid-cols-2 items-start h-full">
          <div className="space-y-6 max-w-full sm:max-w-xl flex flex-col h-full">
            ...
            <div>
              <Button
                className="border-foreground rounded-full px-6 h-12 sm:h-14 text-base sm:text-lg leading-tight tracking-tight mt-4"
                variant={"outline"}
              >
            ...
            <div className="space-y-4 sm:space-y-6 mt-8 sm:mt-auto mb-1">
          ...
          <div className="order-first md:order-none space-y-6 flex flex-col items-center md:items-end">
            ...
            <p className="text-foreground/80 max-w-[40ch] text-center md:text-left md:me-20">
